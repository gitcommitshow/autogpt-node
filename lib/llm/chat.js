 ...
 */
function chatWithAI(agent, prompt, userInput, fullMessageHistory, permanentMemory, tokenLimit) {
    while (true) {
      try {
        model = config.fast_llm_model  // TODO: Change model from hardcode to argument
